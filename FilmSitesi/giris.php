...
<input type="arama" placeholder="Arama">
     ...
     <script>
    function validate(){
        var emailk = document.getElementById("mail");
        var sifrek = document.getElementById("sifre");
        if(emailk.value!=""){
            if(sifrek.value!=""){
                return true;
        }
        ...
        else(alert("Lütfen e-mail adresi girin."));
    }
    </script>
  ...
  <form action="giriskont.php" class="was-validated" method="post">
    <div class="form-group">
        <h4 class="girisbaslik bg-dark"></h4>
    <h6 class="sifread" for="mail">E-mailiniz:</h6>
      <input type="email" class="giris" id="mail" placeholder="Mail Adresiniz" name="mail" required>
      </div>
    <div class="form-group">
      <h6 class="sifread" for="sifre">Şifreniz:</h6>
      <input type="password" class="giris" id="sifre" placeholder="Şifreniz" name="sifre" required>
    </div>
        <input class="form-check-input" type="checkbox" name="remember" style="margin-left: 10px"> <p class="sifread">Şifremi unuttum.</p>
    <button onclick="validate()" name="girisyap" type="submit" class="button" style="margin-left: 10px">Giriş Yap</button>
   
  </form>

        <div class="container">
            <br>
 <p class="sifread">Hesabın yok mu?</p>
      <a href="kayit.php"><button type="button" class="button">Kaydol</button></a>
