...
if(!$conn)
{
    die("Bağlantı başarısız:" . mysqli_connect_error());
      ...
      $sql = "Select film_ID, film_adi, film_resim from filmler WHERE film_ID>=500 && film_ID<505";
...
<h2 class="yazibox">Önerilen Filmler</h2>
         <div class="box">
      ...
      if(mysqli_num_rows($result) > 0)
      {
          ...
          {
              echo "<div style='margin-left: 47px;margin-top: 35px' >";
              echo "<a href='film.php?Fid=".$row["film_ID"]."'><img src='" . $row["film_resim"] . "' class='anafoto' ></a>";
              echo "<p style='color: #c9c9c9; font-size:19px;font-weight: bold; margin-left:20px'>".$row['film_adi']."</p>";
              echo "</div>";
          }
      }
             ?>
        ...
        <h4 class="girisbaslik bg-dark"></h4>
        <h2 style="width: 50%" class="yazibox">Filmlere Göz At</h2>
...
<div id="main2">
  <button class="openbtn" onclick="openBar2()">☰ Kategoriler</button>  
             ...
             <?php
             $sql15 = "Select film_ID, film_adi, film_resim from filmler";
    $return15 = mysqli_query($conn, $sql15);
?>
<div class="blt-row-filmler">
        <div class="row">
            <?php

      if(mysqli_num_rows($return15) > 0)
      {

          while($row15 = mysqli_fetch_assoc($return15))
          {
              echo "<div  class='col-md-4 col-sm-4'>";
              echo "<a href='film.php?Fid=".$row15["film_ID"]."'><img src='" . $row15["film_resim"] . "' class='anaresim' ></a>";
              echo "<p style='color: #c9c9c9; font-size:19px;font-weight: bold; margin-left:20px'>".$row15['film_adi']."</p>";
              echo "</div>";
          }
      }
             ?>
  ...
  <a style="color: azure" href="Anasayfa1.php">1</a>
  <a style="color: azure" id="gecis" href="#">2</a>
