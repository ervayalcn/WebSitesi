...
<body style="background-color: #333">
        ...
        $query = $db->query("SELECT filmler.film_ID, filmler.IMDB,filmler.film_resim, filmler.film_adi, tur.tur_adi, yonetmen.yonetmen_adi, yonetmen.yonetmen_soyadi FROM filmler, tur, yonetmen WHERE filmler.tur_id=tur.tur_id AND filmler.yonetmen_id=yonetmen.yonetmen_id ORDER BY IMDB DESC ");
...
<input type="arama" placeholder="Arama">
    ...
    <section class="kutu1 bg-dark" style=" float:left ">
       ...
       <div style=" width: 300px; background-color: #a964d4 ;box-shadow: 0 5px 1px rgb(55, 8, 103); border-radius: 10px; border: 1px solid black ; margin: auto" > <h4 style="color: whitesmoke;text-align: center">IMDB TOP</h4> </div>
        <br>
        ...
        ?>
                   ...
                   <div class='col-md-4' style="float:left ;border-radius: 10px 10px" >
                      <table class="tbl" style="border-radius: 50px 10px 50px 10px;" >
                           <tr>
                               <td style=" background-color:#696868;text-align: center" > <div style=" color:#ffff00;width: 50px; background-color: #a964d4 ;box-shadow: 0 5px 1px rgb(55, 8, 103); border-radius: 10px; border: 1px solid black ; margin: auto" ><h6><?php echo $row["IMDB"];?></h6></div></td>
                      </tr>
                       <tr>
